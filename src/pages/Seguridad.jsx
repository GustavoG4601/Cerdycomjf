  ...
  const benefits = [
    {
      ...
      desc: "Sistemas integrales que permiten monitorear y proteger tus espacios en todo momento."
    },
    {
      icon: <FaMicrochip />,
      title: "Tecnología Smart",
      desc: "Monitoreo inteligente con analítica de visión para prevenir riesgos antes de que ocurran."
    },
    {
      icon: <FaProjectDiagram />,
      title: "Integración Total",
      desc: "Automatización de dispositivos que crean ambientes seguros y 100% controlables."
    },
    {
      icon: <FaUserShield />,
      title: "Asesoría Senior",
      desc: "Acompañamiento experto desde la planeación hasta la puesta en marcha de tu proyecto."
    }
  ];

  const commitments = [
    "Garantizar confianza en cada solución entregada.",
    "Soporte técnico permanente y especializado.",
    "Proyectos a la medida de tus necesidades reales.",
    "Innovación constante con tecnología de punta."
  ];
  ...
  return (
    <div className="seguridad-page">
        ...
        <div className="hero-overlay-glass">
          <Container>
            <div className="hero-text-wrapper text-center">
              <h6 className="badge-premium mb-3" data-aos="fade-down">SEGURIDAD ELECTRÓNICA</h6>
              <h1 className="display-4 fw-bold text-white mb-4" data-aos="fade-up">
                Protección con <span className="highlight-green">Inteligencia</span>
              </h1>
              <p className="hero-desc text-white-50 mx-auto" data-aos="fade-up" data-aos-delay="200" style={{ maxWidth: "800px" }}>
                En <strong>CERDYCOM JF</strong> convertimos la tecnología en tranquilidad. Diseñamos ecosistemas de seguridad blindados para proteger lo que más amas.
              </p>
            </div>
          </Container>
        </div>
          ...
          <Row className="align-items-center g-5 mt-5">
            <Col lg={6} data-aos="fade-right">
              <div className="commitment-card p-4">
                <h3 className="text-white fw-bold mb-4 h2">Nuestro Compromiso <span>Inquebrantable</span></h3>
            ...
            <Col lg={6} data-aos="fade-left">
              <div className="cta-box-glass p-5 text-center">
                <FaHandshake className="cta-icon mb-4" />
                <h4 className="text-white fw-bold mb-3">¿Listo para blindar tu espacio?</h4>
                <p className="text-white-50 mb-4">Obtén una asesoría gratuita con nuestros especialistas en seguridad.</p>
                <Button
                  href="https://wa.me/573016465632?text=Hola!%20Quiero%20una%20asesoría%20sobre%20Seguridad%20Electrónica."
                  target="_blank"
                  className="whatsapp-btn-modern glow-pulse"
                >
                  <FaWhatsapp className="me-2" /> Solicitar Asesoría Ahora
                </Button>
              </div>
            </Col>
          </Row>
      ...
      <style>{`
        ...
        .glass-benefit-card:hover .benefit-icon-box {
